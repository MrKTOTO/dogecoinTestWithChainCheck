...
public:
    CTestNetParams() {
        ...
        // Enable AuxPoW at 158100
        chainidConsensus = auxpowConsensus;
        chainidConsensus.nHeightEffective = 500000;
        chainidConsensus.fStrictChainId = true;
        ...
        auxpowConsensus.pRight = &chainidConsensus;
        ...
        auxpowConsensus.hashGenesisBlock = consensus.hashGenesisBlock;
        chainidConsensus.hashGenesisBlock = consensus.hashGenesisBlock;
